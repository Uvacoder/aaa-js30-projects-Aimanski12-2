...
function draw() {
  ...
  ctx.b.clearRect(0, 0, canvas.b.width, canvas.b.height);
	...
	origin.x = window.innerWidth * 0.5 + cos(tick * 0.065) * window.innerWidth * 0.45;
  origin.y = window.innerHeight * 0.5 + sin(tick * 0.65) * window.innerHeight * 0.225;
  ...
  ctx.b.save();
  ctx.b.filter = "blur(100px) saturate(0%) contrast(175%)";
