...
> Things I learned in this project;
  * How to use ES6 array filters and mapping.
  * How to loop in a multiple arrays and compare array values.
  * How to swap array values. 
  * How to 'Design first and code later' when writing and application.

  > References:
  * [Javascript arrays](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map)
...
```bash
$ git clone https://github.com/Aimanski12/Javascript_Projects/tree/proj13 proj-name
```
